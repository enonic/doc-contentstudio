...
NOTE: *Content Studio+ feature.* The dedicated *Archive* section in the main menu is part of the <<content-studio-plus#,Content Studio+>> subscription. The *Archive* action itself (moving content to the archive) is available in all installations.
...
NOTE: Archived content can only be restored from the Archive section, which requires <<content-studio-plus#,Content Studio+>>.
