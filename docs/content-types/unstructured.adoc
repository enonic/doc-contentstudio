...
For data that has a known shape and is edited by humans, a custom content type is the better choice — see the https://developer.enonic.com/docs/cms/stable/content/content-types[CMS content type reference].
