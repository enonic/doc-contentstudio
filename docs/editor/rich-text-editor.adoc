...
Block formats:: Apply a paragraph, heading, or other enabled block format.
...
Application-enabled tools:: Additional controls, including inline formats such as bold, italic, and underline, appear when included in the HtmlArea configuration.
Content Studio controls:: Source editing and fullscreen mode appear when available. These controls are provided by Content Studio rather than configured as HtmlArea tools.
...
Depending on the field, you may also see controls for block quotes, text and background colors, horizontal rules, language, copying or removing formatting, and undo or redo. See the https://developer.enonic.com/docs/cms/stable/schemas/form-items/htmlarea[HtmlArea form-item reference] for the complete list of configurable tools.
...
image::rich-text-links.png["Insert Link dialog showing the Content, URL, and Email link types", 820px]
...
image::rich-text-anchor.png[Insert Anchor dialog with an anchor name, 580px]
...
image::rich-text-image.png["Insert Image dialog showing alignment, style, and custom-width controls", 905px]
...
image::rich-text-accessibility.png[Insert Image dialog showing the caption and accessibility settings, 905px]
