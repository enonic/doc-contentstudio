...
image::rich-text-editor.png["Rich Text Editor with its toolbar visible and content containing a heading, text, an image, and a link"]
...
image::rich-text-anchor.png[Insert Anchor dialog with an anchor name]
