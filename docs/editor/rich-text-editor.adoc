...
Rich Text Editor is used by the https://developer.enonic.com/docs/xp/stable/cms/schemas/input-types/htmlarea[HTMLArea input type]
and for editing <<page-editor#_text,Text components>> inside the Page editor.
