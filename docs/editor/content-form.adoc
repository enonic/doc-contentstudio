...
Selecting a component in the tree will highlight the component in the Visual editor and display its configuration in the <<../context-panel/components#,Components widget>>.
