...
image::form-mixins.png["Content Form showing the content type, mixin tabs and optionally the page tab", 674px]
...
Selecting a component in the tree also selects it in the Page Editor and opens its configuration in the <<page-editor#_components_widget,Components panel>>. Use a component's context menu to access its available actions. Components that support moving can also be rearranged by dragging them in the tree.
...
image::form-rename.png[Rename content item dialog showing the current path name and a new name being entered, 760px]
