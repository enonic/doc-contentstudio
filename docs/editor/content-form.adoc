...
Selecting a component in the tree will highlight the component in the Visual editor and display its configuration in the <<context-panel#_components,Components widget>>.
...
in the <<preview/visual-editor#editing-page,Visual editor>>.
