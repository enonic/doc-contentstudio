...
User access::
The effective <<navigator/permissions#,permissions>> for the current user. The *Edit Permissions* link opens the permissions dialog.
...
Page template::
The <<sites/page-templates#,page template>> used to render the content, if any.
