...
* The *Version history* widget lists every version of the selected item and lets you compare or revert. See <<versions#,Versions>>.
* The *Dependencies* widget shows the inbound and outbound references between the item and other content. See <<dependencies#,Dependencies>>.
