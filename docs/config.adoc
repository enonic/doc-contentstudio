...
See https://developer.enonic.com/docs/cms/stable/schemas/form-items/contentselector#allowContentType[description].
...
image::pubwiz-required-publish-from.png[Publishing Wizard - Required "Online from", 821w]
...
.Only mandatory dependencies (default behaviour)
image::pubwiz-dependencies-mandatory.png[Publishing Wizard - mandatory dependencies, 822w]

.All dependencies
image::pubwiz-dependencies-all.png[Publishing Wizard - all dependencies, 821w]
