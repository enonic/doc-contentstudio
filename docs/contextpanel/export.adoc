...
After completing the import, the result reports how many nodes were added and updated. Imported content is placed in the target project's _draft_ branch. Review it in the Navigator and use the normal <<../actions/publish#,publishing flow>> when it is ready to go online.
