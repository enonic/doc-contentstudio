...
NOTE: *Content Studio+ feature.* AI translation is part of the https://market.enonic.com/vendors/enonic/content-studio-plus[Content Studio+] subscription. It also requires the https://market.enonic.com/vendors/enonic/juke-ai-content-translator[Juke AI Content Translator] application.
...
NOTE: Changing these settings requires the <<../projects#project-roles,Owner>> project role or higher.
...
NOTE: *Content Studio+ feature.* The Layers widget is part of the https://market.enonic.com/vendors/enonic/content-studio-plus[Content Studio+] subscription.
...
TIP: Read about the high-level concept of Content Layers https://developer.enonic.com/docs/cms/stable/content/layering[here].
