...
To create a new variant, select a content item in the <<../navigator#,Navigator>> grid, then open the "Variants" widget in the <<../contextpanel#,Context panel>> on the right-hand side (if you cannot find it then you probably don't have *Content Studio+* installed) and click "*Create Variant*" button.
