...
See the https://developer.enonic.com/docs/code/stable/extensions/liveview[Live view extension reference] for the descriptor format, lifecycle, and implementation details.
