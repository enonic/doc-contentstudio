...
image::navigator.png[Content Studio navigator showing content content list, preview and detail view, 1440px]
 ...
 * If selected content is not published: *Publish* (opens the <<../actions/publish#publishing_wizard,Publishing wizard>> dialog)
 ...
 * If selected content is published but has child items that are not published: *Publish Tree* (opens the <<../actions/publish#publish_tree,Publishing wizard>> dialog with selected content and all descendants)
