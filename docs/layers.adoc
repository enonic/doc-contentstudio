...
NOTE: *Content Studio+ feature.* AI translation is part of the <<content-studio-plus#,Content Studio+>> subscription. It also requires the https://market.enonic.com/vendors/enonic/juke-ai-content-translator[Juke AI Content Translator] application.
...
NOTE: *Content Studio+ feature.* The Layers widget is part of the <<content-studio-plus#,Content Studio+>> subscription.
