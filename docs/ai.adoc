...
NOTE: *Content Studio+ feature.* The AI Assistant is part of the https://market.enonic.com/vendors/enonic/content-studio-plus[Content Studio+] subscription. It also requires the https://market.enonic.com/vendors/enonic/ai-content-operator[Juke AI Content Operator] application.
...
* <<projects/layers#, AI localization>> can't be invoked from chat
