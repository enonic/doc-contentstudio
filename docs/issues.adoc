...
*Tasks* are general editorial work items — "spellcheck this article", "add new content to this section". See <<#_tasks,Tasks>> below.

*Publish requests* ask another user to review and publish content. Because they have their own wizard and dialog, they are documented on a dedicated page — see <<issues/publish-request#,Publish request>>.
...
You can read about creating a new Publishing Request on the <<issues/publish-request#,Publish request>> page.
