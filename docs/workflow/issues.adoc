...
The *Request publishing* action is available from the same places as <<../actions/publish#,Publish>> — the toolbar, the context menu, and the Content Editor — but it replaces the *Publish* button for users without publish permission.
